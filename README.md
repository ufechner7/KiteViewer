...
To test the 4-point simulator and steer the kite with a joystick, look at [KiteSimulators](https://github.com/ufechner7/KiteSimulators) .
...
- The metapackage [KiteSimulators](https://github.com/ufechner7/KiteSimulators)
